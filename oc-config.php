<?php
$sqlite3db = new SQLite3('OpenCAD.db');
/**#@+
 ...
 * @since 1.0a RC1
 **/
define('COMMUNITY_NAME', 'OpenCAD Live SQLITE3');
...
/**#@+
  * ENABLE_API_SECURITY
  *
  * The API-Key is used to authenticate requests from logged out users,
  * it is also used in creating cookie 'aljksdz7' which stores the API-Key
  * and the session id of the logged in user.
  *
  * This setting should always be enabled. (If so, why is it a setting?)
  * 
