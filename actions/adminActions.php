...
function delete_user()
{
    ...
    sendWebhook("User " . $_SESSION['username'] . " deleted user with ID " . $uid, "User/Delete");
    $PluginApi->audit_log("[User/Delete] User " . $_SESSION['username'] . " deleted user with ID " . $hisRank);
