		...
		<form action="./actions/login.php" method="post">
			...
			<div class="row">
				<div class="input-field col offset-s4 s4">
					...
					<?php if (!LOGIN_CAPTCHA_ENABLED) { ?>
						...
						<a class="btn red darken-4" onclick="M.toast({html: 'Contact an admin to reset your password.', classes:'red darken-4'});">Forgot
							Password?</a>
			...
			<?php if (LOGIN_CAPTCHA_ENABLED) { ?>
				...
				<div class="row">
					...
					<div class="row">
						<div class="input-field col offset-s4 s4">
							<p class="center-align">OpenCAD Version
								<?php $Plugin_API->get_oc_version_name();
								echo " ";
								$Plugin_API->get_oc_version_build(); ?>
							</p>
						</div>
					</div>
				<?php } ?>
