                ...
                <div class="modal-body">
                    <form role="form" action="<?php echo BASE_URL; ?>/actions/civActions.php" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <select class="form-control selectpicker" name="warrant_name_sel" id="warrant_name_sel"
                                    data-live-search="true" title="Select a Warrant">
                ...
                <div class="modal-body">
                    <form role="form" action="<?php echo BASE_URL; ?>/actions/civActions.php" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="civDobReq" class="form-control" id="datepicker" maxlength="10"
                                    value="<?php echo $civDob; ?>" required />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <select name="civRaceReq" class="form-control selectpicker civRaceReq_picker"
                                    id="civRaceReq" title="Select a race or ethnicity" data-live-search="true" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <select name="civLicense" class="form-control selectpicker" id="civLicense"
                                    title="Status" required>
                                    <option name='Unobtained' value='Unobtained'>Unobtained</option>
                                    <option name='ValidStudent' value='ValidStudent'>Valid (STUDENT)</option>
                                    <option name='Valid' value='Valid'>Valid</option>
                                    <option name='ValidCDL' value='ValidCDL'>Valid CDL</option>
                                    <option name='Suspeneded' value='Suspeneded'>Suspended</option>
                                </select>
                                <!-- ./ col-sm-9 -->
                            </div>
                            <!-- ./ form-group -->
    ...
    <div class="modal fade" id="editIdentityModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <!-- ./ modal-header -->
                <div class="modal-body">
                    <form role="form" action="<?php echo BASE_URL; ?>/actions/civActions.php" class="editname_modalform"
                        method="post">
                        <div class="form-group row">
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-2 control-label">Name</label>
                            <div class="col-lg-10">
                                <input name="civNameReq" class="form-control civNameReq" id="civNameReq"
                                    value="<?php echo $civName; ?>" required />
                                <span class="fasfa-user form-control-feedback right" aria-hidden="true"></span>
                            </div>
                            <!-- ./ col-sm-9 -->
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label">Date of Birth</label>
                            <div class="col-lg-10">
                                <input type="text" name="civDobReq" class="form-control civDobReq" id="datepicker2"
                                    maxlength="10" value="<?php echo $civDob; ?>" readonly />
                                <span class="fasfa-calendar form-control-feedback right" aria-hidden="true"></span>
                            </div>
                            <!-- ./ col-sm-9 -->
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label">Address</label>
                            <div class="col-lg-10">
                                <input type="text" name="civAddressReq" class="form-control civAddressReq"
                                    id="civAddressReq" value="<?php echo $civAddr; ?>" required />
                                <span class="fasfa-location-arrow form-control-feedback right"
                                    aria-hidden="true"></span>
                            </div>
                            <!-- ./ col-sm-9 -->
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label">Sex</label>
                            <div class="col-lg-10">
                                <select name="civSexReq" class="form-control selectpicker selectpicker3" id="civSexReq"
                                    title="Select a sex" data-live-search="true" required>
                                    <?php getDataSetColumn($table = "ncic_names", $data = "gender", $leadTrim = 11, $followTrim = 16); ?>
                                </select>
                            </div>
                ...
                <div class="modal-body">
                    <form role="form" action="<?php echo BASE_URL; ?>/actions/civActions.php" method="post">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label">Registered Owner</label>
                            <div class="col-lg-10">
                                <select class="form-control selectpicker civilian_names_picker" name="civilian_names"
                                    id="civilian_names" data-live-search="true" required>
                                    <?php getCivilianNamesOwn(); ?>
                                </select>
                            </div>
                            <!-- ./ col-sm-9 -->
